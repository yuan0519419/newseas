...
:deep(.el-table) {
  ...
  .el-table__header {
    background: linear-gradient(90deg, rgba(17, 24, 39, 0.9) 0%, rgba(30, 41, 59, 0.9) 100%) !important;
  ...
  .el-table__body {
    tr {
      background: linear-gradient(90deg, rgba(17, 24, 39, 0.6) 0%, rgba(26, 32, 44, 0.6) 100%) !important;
